        ...
        <div class="kt-portlet__body">
           <form class="report-form" id="filterForm">
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable" id="datatable">
                ...
                <tr>
                    <th>#</th>
                    <th width="30%">@lang('general.title')</th>
...
@push('js')
    ...
    <script>
        ...
        table.DataTable({
            ...
            columns: [
                ...
                {data: 'dt_modified_date'},
                {
                    ...
                    searchable: false,
                    sortable: false,
                    visible: {{ (int) auth()->user()->can('slider-status') }}
                },
                {
                    data: 'actions_column',
                    searchable: false,
                    sortable: false,
                    visible: {{ (int) (auth()->user()->can('slider-store') ||  auth()->user()->can('slider-delete')) }},
        ...
        function openModal(id = '') {
            $.get('{{ route('admin.slider.form') }}?id=' + id, function (data) {
