...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('t_article_translations', function (Blueprint $table) {
            $table->id('pk_i_id');
            $table->string('s_locale', 2);
            $table->string('s_name');
            $table->text('s_description');
            $table->foreignIdFor(\App\Models\Article::class, 'fk_i_article_id')->nullable();
            $table->timestamp('dt_created_date')->nullable();
            $table->timestamp('dt_modified_date')->nullable();
            $table->timestamp('dt_deleted_date')->nullable();
        });
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('t_article_translations');
    }
};
