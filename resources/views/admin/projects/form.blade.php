<form action="{{ route('admin.projects.store') }}" method="post">
    @csrf
    @isset($project)
        <input type="hidden" name="pk_i_id" value="{{ $project->getKey() }}"/>
    @endisset

    <x-localizable-inputs :inputs="$inputs" :item="$project">
            ...
            <div class="col-lg-12 col-xl-12">
                <div class="kt-avatar kt-avatar--outline" id="kt_user_avatar_1">
                    <div class="kt-avatar__holder"
                         style="background-image: url({{ $project && $project->s_cover ?  asset($project->s_cover) : '' }})"></div>
