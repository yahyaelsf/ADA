<form action="{{ route('admin.roles.process') }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input name="name" value="{{ $role->name ?? '' }}" type="text" class="form-control" {{ isset($role) ? 'readonly' : '' }}>
            </div>
        </div>
    </div>
