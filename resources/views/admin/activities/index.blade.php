...
@push('js')
    <script>
        ...
        table.DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ route('admin.activities.data') }}',
            columns: [{
                    data: 'pk_i_id'
                },
                ...
                {data: 'dt_modified_date'},
                {
                    ...
                    visible: {{ (int) (auth()->user()->can('activities-store') || auth()->user()->can('activities-delete')) }}
                },
        ...
        function openModal(id = '') {
            $.get('{{ route('admin.activities.form') }}?id=' + id, function(data) {
